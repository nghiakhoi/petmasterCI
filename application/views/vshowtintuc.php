...
<tr class="odd">
    <td class="  sorting_1"><?php echo $item['idtintuc'];?></td>
    <td class=" "><?php echo $item['tieude'];?></td>
	<td class=" "><img width="100px" height="100px" src="<?php echo base_url();?>uploads/<?php echo $item['hinhdaidien'];?>"  border="0" /></td>

    
    <td class=" ">
        <div class="text-right">
            <a href="<?php echo base_url();?>cadmin/suatintuc/<?php echo $item['idtintuc'];?>" class="btn btn-success btn-mini">
                <i class="icon-edit"></i>
            </a>
            <a href="<?php echo base_url();?>cadmin/xoatintuc/<?php echo $item['idtintuc'];?>" onclick="return confirm('Chắc chắn muốn xóa?  ');" class="btn btn-danger btn-mini">
