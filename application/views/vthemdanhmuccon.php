...
<div id="page-heading"><h2>Thêm danh mục con</h2></div>
...
<tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
        <tr>
            ...
            <td><?php echo form_input($tendanhmuccon); ?></td>
            <td></td>
        </tr>
        ...
        <td>  <select  name="danhmuccha" class="styledselect_form_1">
...
<td></td>
 ...
 <div id="table-content">
				...
				<tr>
					...
					<th class="table-header-repeat line-left"><a style="color:white;" href="#">Tên danh mục cha</a>	</th>					
				...
				<tr>
					...
					<td><?php echo $item['tendmcon'];?></td>
					<td><?php foreach($danhmuccha as $items){ if($items['iddmcha']==$item['iddmcha']) echo $items['tendmcha']; else echo "";}?></td>	
										
					
					
					<td class="options-width">
					<a onclick="myFunction<?php echo $item['iddmcon']; ?>()" title="Sửa" class="icon-1 info-tooltip" href ="javascript:void{0};"></a>
					
					<?php $chuoi=base_url()."cadmin/suadanhmuccon/".$item['iddmcon'];
					$dem=0;
					$detai=$item['iddmcon'];
...
function myFunction$detai() {
    ...
    myWindow.focus();
					...
					<a title="Xóa" class="icon-2 info-tooltip" href ="<?php echo base_url();?>cadmin/xoadanhmuccon/<?php echo $item['iddmcon'];?>" onclick="return confirm('Chắc chắn muốn xóa danh mục [<?php echo $item['tendmcon'];?>]?');"></a>
					</td>
