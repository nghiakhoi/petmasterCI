...
<div id="page-heading"><h2>Sửa loại sản phẩm</h2></div>
...
<tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
        <tr>
            ...
            <td><?php echo form_input($tendmsubcon); ?></td>
            <td></td>
        </tr>
        ...
        <td>  <select id="danhmuccon" name="danhmuccon" class="styledselect_form_1">
		<option value="<?php echo $info['iddmcon'];?>"><?php echo $info['tendmcon'];?></option>
				<?php 
				
				foreach($info1 as $item)
				{?>
                    <?php if($info['iddmcon']!=$item['iddmcon'])echo '<option value="'.$item['iddmcon'].'">';?><?php if($info['tendmcon']!=$item['tendmcon'])echo $item['tendmcon']."</option>";?>
                 <?php };   ?>
                </select>
