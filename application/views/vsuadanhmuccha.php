...
<div id="page-heading"><h2>Sửa danh mục cha</h2></div>
...
<tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
        <tr>
            <th valign="top"><?php echo form_label("Tên danh mục cha: ")?></th>
            <td><?php echo form_input($tendanhmuccha); ?></td>
            <td></td>
        </tr>
		
		<tr>
            <th valign="top"><?php echo form_label("Vị trí: ")?></th>
            <td><?php echo form_input($vitri); ?></td>
            <td></td>
        </tr>
