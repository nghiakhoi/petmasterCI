...
<tr class="odd">
    ...
    <td class=" "><?php echo $item['motangan'];?></td>
	
    <td class=" ">
        <div class="text-right">
            <a href="<?php echo base_url();?>cadmin/suadichvukhac/<?php echo $item['id'];?>" class="btn btn-success btn-mini">
                <i class="icon-edit"></i>
            </a>
            <a href="<?php echo base_url();?>cadmin/xoadichvukhac/<?php echo $item['id'];?>" onclick="return confirm('Chắc chắn muốn xóa?  ');" class="btn btn-danger btn-mini">
