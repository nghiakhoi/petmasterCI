...
<div class="addthis_toolbox addthis_default_style" addthis:url="http://www.hotdeal.vn/ho-chi-minh/" style="float: right; margin-right: 20px; margin-top: 2px;">
...
<h1 class="mainbox-title"><span><span class="secure-page-title"><?php echo $tendanhmuc['tendmcon'];?></span></span></h1>
<div class="clear"></div>
<div class="home_bg feature-row" style="margin:auto;">
<div id="list_product_item" style="margin-top:30px;margin-left:5px;">
<div style="margin-left:-37px;">
<div class="row product-row-dealtoday product-row 0">
<div style='margin-left:30px;font-size:30px'>Chưa có sản phẩm nào</div>	
