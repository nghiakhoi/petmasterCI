        ...
        <div class='row-fluid'>
            <div class='span12'>
                <div class='box-content box-statistic'>
                    <h3 class='title text-error'><?php echo online(); ?></h3>
                    <small>Đang online</small>
                    <div class='text-error icon-user align-right'></div>
                </div>
                <div class='box-content box-statistic'>
                    <h3 class='title text-success'><?php echo today(); ?></h3>
                    <small>Truy cập hôm nay</small>
                    <div class='text-success icon-time align-right'></div>
                </div>
                <div class='box-content box-statistic'>
                    <h3 class='title text-primary'><?php echo total(); ?></h3>
                    <small>Tổng số truy cập</small>
                    <div class='text-primary icon-book align-right'></div>
                </div>
            </div>
        </div>
    </div>