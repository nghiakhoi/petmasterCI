...
<div class="box-header blue-background">
    <div class="title">Danh sách danh mục tin tức</div>
...
<tr class="odd">
    <td class="  sorting_1"><?php echo $item['iddmtintuc'];?></td>
    <td class=" "><?php echo $item['tendmtintuc'];?></td>

    <td class=" ">
        <div class="text-right">
            <a href="<?php echo base_url();?>cadmin/suadanhmuctintuc/<?php echo $item['iddmtintuc'];?>" class="btn btn-success btn-mini">
                <i class="icon-edit"></i>
            </a>
            <a href="<?php echo base_url();?>cadmin/xoadanhmuctintuc/<?php echo $item['iddmtintuc'];?>" onclick="return confirm('Chắc chắn muốn xóa danh mục này?  ');" class="btn btn-danger btn-mini">
